...
#step 8 - Training on gpu with constant epoch number
# I
batch_size = 32
epoch =50
...
file1=open('../finalanalysis/constantepochservergpu.dat','w')
...
plt.savefig("Transfer_model_result3250gpu.png")
#plt.show()                                                                                        
...
plt.savefig("Transfer_model_result6450gpu.png")
...
plt.savefig("Transfer_model_result12850gpu.png")
...
Train_time = (datetime.now() - Train_time).total_seconds()
print("training time: ",Train_time)
file2=open('.../finalanalysis/constantbatchservergpu.dat','w')
...
plt.savefig("Transfer_model_result128100gpu.png")
...
plt.savefig("Transfer_model_result128150gpu.png")
