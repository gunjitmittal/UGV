...
file1=open('../finalanalysis/constantepochlocalcpu.dat','w')
...
plt.savefig("Transfer_model_result3250.png")
#plt.show()                                                                                        
...
plt.savefig("Transfer_model_result6450.png")
...
plt.savefig("Transfer_model_result12850.png")
...
Train_time = (datetime.now() - Train_time).total_seconds()
print("training time: ",Train_time)
file2=open('../finalanalysis/constantbatchlocalcpu.dat','w')
...
plt.savefig("Transfer_model_result128100.png")
...
plt.savefig("Transfer_model_result128150.png")
